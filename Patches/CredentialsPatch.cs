...
#if DEBUG
      //  Main.credentialsText += $"\r\n<color=#a54aff>Modified by </color><color=#ff3b6f>毒液/color>";
        Main.credentialsText += $"\n<size=75%><color=#ffc0cb>TOHE</color> <color=#BA55D3>by</color> <color=#ffc0cb>KARPED1EM</color>\n<color=#00BFFF>NTOHER</color> <color=#BA55D3>by</color> <color=#87CEFA>毒液</color> & <color=#00FFFF>LezaiYa</color></size>";
#endif
