...
internal static class CustomRolesHelper
{
    ...
    public static bool CheckAddonConfilct(CustomRoles role, PlayerControl pc)
    {
        ...
        if (role is CustomRoles.Seer && ((pc.GetCustomRole().IsCrewmate() && !Options.CrewCanBeSeer.GetBool()) || pc.Is(CustomRoles.Councillor) || (pc.GetCustomRole().IsNeutral() && !Options.NeutralCanBeSeer.GetBool()) || (pc.GetCustomRole().IsImpostor() && !Options.ImpCanBeSeer.GetBool()))) return false;
