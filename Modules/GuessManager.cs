...
public static class GuessManager
{
    ...
    public static bool GuesserMsg(PlayerControl pc, string msg, bool isUI = false)
    {
        ...
        else if (operate == 2)
        {
            ...
            if (target != null)
            {
                ...
                if (pc.GetCustomRole().IsImpostor() && !pc.Is(CustomRoles.EvilGuesser) && !pc.Is(CustomRoles.Councillor))
                {
    ...
    public static Sprite NoNamePlateSpite { get; private set; }
    ...
    static void GuesserOnClick(byte playerId, MeetingHud __instance)
    {
        ...
        try
        {
            ...
            exitButton.gameObject.GetComponent<SpriteRenderer>().sprite = NoNamePlateSpite;
